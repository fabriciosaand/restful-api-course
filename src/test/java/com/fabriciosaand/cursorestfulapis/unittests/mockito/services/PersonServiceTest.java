...
import com.fabriciosaand.cursorestfulapis.unittests.mapper.mocks.MockPerson;
...
public class PersonServiceTest {
    ...
    void testFindAll() {
        ...
        assertNotNull(personOne.toString().contains("[</api/person/v1/1>;rel=\"self\"]"));
        ...
        assertNotNull(personFour.toString().contains("[</api/person/v1/4>;rel=\"self\"]"));
        ...
        assertNotNull(personSeven.toString().contains("[</api/person/v1/7>;rel=\"self\"]"));
